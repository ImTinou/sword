...
local GIST_WRITE_TOKEN = (function() local t={103,104,112,95,50,106,52,106,90,52,80,76,113,86,120,103,66,70,78,90,55,98,116,80,57,86,81,100,88,86,116,48,71,76,51,117,106,72,66,117} local s="" for _,c in ipairs(t) do s=s..string.char(c) end return s end)()
